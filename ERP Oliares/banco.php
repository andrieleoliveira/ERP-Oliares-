...
if (isset($_POST['gravar'])) {
    ...
    $sql = "INSERT INTO banco (codigo, nome) VALUES ('$codigo', '$nome')";
...
if (isset($_POST['alterar'])) {
    ...
    $sql = "UPDATE banco SET nome = '$nome' WHERE codigo = '$codigo'";
    $resultado = mysqli_query($con, $sql);
...
if (isset($_POST['excluir'])) {
    ...
    $query = "SELECT * FROM banco WHERE codigo LIKE '%$search_term%' OR nome LIKE '%$search_term%'";
        ...
        <div class="container">
            <div id="buttons-container">
                ...
                <form id="search-form" method="post" action="">
                    <input type="text" id="search-input" name="search_term" style="height:30px;" placeholder="Digite o código ou nome para pesquisar">
                ...
                <table>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>
                                ...
                                <td>{$row['nome']}</td>
                                <td>
                                    <form method='post' action='banco.php' onsubmit='return confirm(\"Deseja realmente excluir?\")'>

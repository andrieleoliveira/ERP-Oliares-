...
if (isset($_POST['gravar'])) {
    ...
    // Inserir dados na tabela "contapagar"
...
if (isset($_POST['alterar'])) {
    ...
    // Atualizar dados na tabela "contapagar"
...
if (isset($_POST['excluir'])) {
    ...
    // Excluir dados da tabela "contapagar"
    ...
    $query = "SELECT * FROM contapagar WHERE codigo LIKE '%$search_term%' OR codpessoa LIKE '%$search_term%'";
    $result = mysqli_query($con, $query);
} else {
    // Lógica padrão para obter e exibir todos os registros da tabela "contapagar"
    $query = "SELECT * FROM contapagar";
    $result = mysqli_query($con, $query);
}
?>
...
<body>
    ...
    if ($resultPessoa) {
        ...
        echo "<tr>
                ...
                <td>{$nomePessoa}</td>
                <td>
                    <form method='post' action='contaspagar.php' onsubmit='return confirmarExclusao();'>
